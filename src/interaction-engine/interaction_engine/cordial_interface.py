...
class CordialInterface(Interface):
    ...
    def __init__(self, action_name, seconds_until_timeout=None):
        ...
        if type(seconds_until_timeout) is not None:
    ...
    def _format_user_input(self, message, user_input):
        if message.message_type == Message.Type.MULTIPLE_CHOICE:
...
if __name__ == "__main__":
    cordial_interface = CordialInterface(action_name='cordial/say_and_ask_on_gui')
