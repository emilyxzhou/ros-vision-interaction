...
ask_age = State(
    name="ask age",
    message_type=Message.Type.TEXT_ENTRY,
    contents="How old are you, {ask name}?",
    next_states=["confirm"],
...
confirm_name_and_age = State(
    ...
    contents="Your name is {ask name} and you are {ask age} years old, is that right?",
...
greeting = State(
    ...
    contents=["Hi {ask name}!", "Hello {ask name}!"],
...
breakfast = State(
    name="breakfast",
    message_type=Message.Type.MULTIPLE_CHOICE,
    contents="Did you eat breakfast today?",
...
water = State(
    name="water",
    message_type=Message.Type.MULTIPLE_CHOICE,
    contents=["Are you staying hydrated?"],
...
take_care = State(
    name="take care",
    message_type=Message.Type.MULTIPLE_CHOICE,
    contents="Don't forget to take care of yourself!",
    next_states=["goodbye"],
...
goodbye = State(
    name="goodbye",
    message_type=Message.Type.MULTIPLE_CHOICE,
    contents=["Bye!", "Goodbye!", "Have a nice day!"],
    next_states=["exit"],
